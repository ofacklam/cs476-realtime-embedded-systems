...
# Memory: internal_memory_0
MEM_0 := system_internal_memory_0
$(MEM_0)_NAME := internal_memory_0
...
$(MEM_0)_HIERARCHICAL_PATH := internal_memory_0
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: internal_memory_0
internal_memory_0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
