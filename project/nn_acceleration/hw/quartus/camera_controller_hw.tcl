...
set_interface_property camera_conduit associatedReset reset_sink
...
add_interface_port camera_conduit fval fval Input 1
add_interface_port camera_conduit lval lval Input 1
add_interface_port camera_conduit pixclk pixclk Input 1
